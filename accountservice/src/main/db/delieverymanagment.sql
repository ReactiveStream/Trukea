CREATE DATABASE  IF NOT EXISTS `trukeadeliverymanagementservicedb` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `trukeadeliverymanagementservicedb`;
-- MySQL dump 10.13  Distrib 8.0.25, for Linux (x86_64)
--
-- Host: localhost    Database: trukea_deliverymanagementservicedb
-- ------------------------------------------------------
...
--
-- Dumping data for table `direct_post_pickup`
--

LOCK TABLES `direct_post_pickup` WRITE;
/*!40000 ALTER TABLE `direct_post_pickup` DISABLE KEYS */;
/*!40000 ALTER TABLE `direct_post_pickup` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `payment_order_account`
--

LOCK TABLES `payment_order_account` WRITE;
/*!40000 ALTER TABLE `payment_order_account` DISABLE KEYS */;
/*!40000 ALTER TABLE `payment_order_account` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2021-07-30 22:01:18
