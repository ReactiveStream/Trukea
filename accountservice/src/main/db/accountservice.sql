CREATE DATABASE  IF NOT EXISTS `trukeaaccountservicedb` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `trukeaaccountservicedb`;
-- MySQL dump 10.13  Distrib 8.0.25, for Linux (x86_64)
--
-- Host: localhost    Database: trukea_accountservicedb
-- ------------------------------------------------------
...
--
-- Dumping data for table `store_terms_and_conditions`
--

LOCK TABLES `store_terms_and_conditions` WRITE;
/*!40000 ALTER TABLE `store_terms_and_conditions` DISABLE KEYS */;
/*!40000 ALTER TABLE `store_terms_and_conditions` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2021-07-30 21:46:28
